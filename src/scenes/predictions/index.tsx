  ...
  const formattedData = useMemo(()=>{
   ...
   return monthData.map(({month, revenue}, i:number)=>{
    return {
      ...
      "Regriession Line": regressionLine.points[i][1],
    ...
    <DashboardBox width="100%" height="100%" p="1rem" overflow="hidden">
       ...
       <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Label value="Revenue in USD" angle={-90} offset={0} position="inside"/>
          </YAxis>
          
          <Tooltip />
          <Legend verticalAlign='top' />
          <Line 
            type="monotone" dataKey="Actual Revenue" stroke={palette.primary.main} strokeWidth={0} dot={{strokeWidth:5}}
          />
